...
### Tmax 아파치, 톰캣 파트너사 교육 수강

교육 수강✍  
전략적 비즈니스를 위한 파트너사(Tmax) 오프라인 교육 수강  
`2021.09.13 - 2021.09.14` by **Tmax**

### KOSTA 재직자 교육 특강

교육 수강✍  
Ansible을 이용한 AWS 클라우드 DevOps 자동화 구현  
`2021.09.15 - 2021.09.17` by **KOSTA**

### Cloud PaaS-TA 자격증 교육 수강

교육 수강✍  
한국지능정보사회진흥원(NIA)의 지원 아래 국내 CSP의 경쟁력을 강화하기 위한 PaaS-TA(개방형 클라우드 플랫폼)
`2021.10.18 - 2021.10.23` by **PaaS-TA**
