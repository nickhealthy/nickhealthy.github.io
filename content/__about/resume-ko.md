...
### 한국폴리텍 융합기술교육원 - 임베디드 시스템과

교육 수료✍  
임베디드 프로그래밍 및 PCB 보드 설계 등의 임베디드 관련 교육 수료  
`2019.03.05 - 2019.12.06` by **한국폴리텍 융합기술교육원**

### SAFFY 대비 스터디

스터디 모임장✍  
매 주말(토) 풀이할 문제 준비 및 리뷰  
`2020.03 - 2020.06` by **개인적 스터디 운영**

### 멀티캠퍼스 - 클라우드(MSA) 서비스 개발

교육 수료✍  
총 3개의 프로젝트를 진행하며, 클라우드 활용 및 마이크로서비스 아키텍처 개발자 과정  
`2020.07.13 - 2020.12.24` by **멀티캠퍼스**

### 부스트코스(NAVER): 부스트 코딩 뉴비 챌린지

컴퓨터 공학 지식을 채우기 위한 챌린지🎓  
매주 하버드의 'CS50' 강의를 듣고 정해진 과제를 C언어를 통해 팀원끼리 해결  
6주차 우수조선정 및 리뷰 방송에 소개됨🎓  
`2020.07.10 - 2020.08.28` by **네이버커넥트**

### 코딩 스터디

스터디 팀원✍  
매일 1문제씩 백준, 프로그래머스를 풀이 및 1주마다 백준 단계별 풀이를 통해 알고리즘 실력 향상  
...
### Naver Cloud Platform, 파트너사 교육 수강

교육 수강 및 네이버클라우드Professional 자격증 취득✍  
...
교육 수강✍  
전략적 비즈니스를 위한 파트너사 솔루션(아파치, 톰캣) 오프라인 교육 수강  
`2021.09.13 - 2021.09.14` by **Tmax**

### 한국소프트웨어기술진흥협회(KOSTA) 재직자 교육 특강

교육 수료✍  
교육명: Ansible을 이용한 AWS 클라우드 DevOps 자동화 구현  
`2021.09.15 - 2021.09.17` by **한국소프트웨어기술진흥협회(KOSTA)**

### 개방형 클라우드 플랫폼 파스타 전문가 교육(PaaS-TA)

교육 수강 및 수료테스트 완료✍  
한국지능정보사회진흥원(NIA)의 지원 아래 국내 CSP의 경쟁력을 강화하기 위한 PaaS-TA(개방형 클라우드 플랫폼) 교육 수료  
`2021.10.18 - 2021.10.25` by **한국정보화진흥원, (사)오픈플랫폼 개발자커뮤니티**
